...
* *Bandeja de controladoras* -- contiene las unidades, contenedores de alimentación/ventilador y controladores. Una controladora puede tener una configuración simple (una sola controladora) o doble (dos controladoras).
...
Una controladora es la combinación de hardware y firmware que implementa funciones de cabina de almacenamiento y gestión. Incluye la memoria caché, el soporte para unidades y el soporte de interfaz host (SAS, FC, iSCSI).
